...
class Paddle:
    ...
    def update(self):
        ...
        if pyxel.mouse_x > self.w_paddle / 2 + self.x_paddle and (0 < pyxel.mouse_x <= self.w_layout) and (0 < pyxel.mouse_y <= self.h_layout):
    ...
    def draw(self):
        pyxel.blt(self.x_paddle, self.y_paddle, 0, 0, 0, self.w_paddle, self.h_paddle)
