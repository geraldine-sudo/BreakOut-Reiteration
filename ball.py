...
class Ball:
    def __init__(self,main, x: float, y: float, paddle: Paddle, gravity: int, bricks: None, launch: bool) -> None:
        #layout
        self.main = main
        self.w_layout = 120
        self.h_layout = 200
    ...
    def update(self):
        ...
        if self.launch:
            if (self.degree == 180 or self.degree == 0) and not self.main.anti_gravity:
                self.acc_y = 0
    ...
    def draw(self):
        ...
        if not self.launch and self.degree != None:
            ...
            pyxel.text(self.paddle.x_paddle + self.paddle.w_paddle//2 -4,self.paddle.y_paddle + 7, f"{self.degree}", pyxel.COLOR_BLACK, None)
            length = 15
            ...
            pyxel.line(self.paddle.x_paddle +self.paddle.w_paddle //2,self.paddle.y_paddle,x2,y2, pyxel.COLOR_BLACK)
